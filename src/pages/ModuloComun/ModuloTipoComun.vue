  ...
  <div class="row">
    <!-- <div class="row justify-content-center"> -->
      <!-- <div class=""> -->
        ...
        <card class="card mx-auto col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" title="Tipo de los Cursos" icon="ti-arrow-left">
          <card class="card col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4" v-for="d in data" :key="d.id">
              <div id="carta">
                  ...
                  <tbody>
                    <slot name="tipos">
                      <div class="icon-container" style="cursor: pointer" v-on:click.prevent="tipo(d.id)">
...
export default {
  ...
  created(){
    ...
    axios.get(`https://branditechnology.herokuapp.com/api/auth/modalidad/cursos/ver/${this.id}`,{
      headers:{
        'Authorization': `Bearer ${this.token}`
      }
    }).then((result) => {
      // console.log(result);
      this.data = result.data.modalidad.tipo_de_curso
    }).catch(error => {
      // console.log(error);
    })
  },
